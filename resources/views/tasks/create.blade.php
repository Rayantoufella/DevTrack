...
<title>DevTrack — Nouvelle tâche</title>
  ...
  <main class="flex-1 min-w-0 relative">
    ...
    <header class="sticky top-0 z-30 bg-cream/95 backdrop-blur border-b-[3px] border-ink">
      <div class="main-pad px-8 py-4 flex items-center gap-4">
        <nav class="flex items-center gap-2 font-mono text-[12px] font-semibold">
          ...
          <span class="text-ink/30">/</span>
          <span class="text-ink">New task</span>
        </nav>
    ...
    <div class="main-pad relative px-8 py-10 stagger">
      <div class="max-w-[680px] mx-auto">
        ...
        <div class="mb-6">
          <div class="font-mono text-[11px] font-semibold tracking-[0.18em] text-electric-blue uppercase mb-2">// new task</div>
          <h1 class="font-display font-bold text-[36px] sm:text-[44px] leading-[1] tracking-tight">Créer une tâche.</h1>
        </div>
        ...
        <div class="form-card">
          <form method="POST" action="{{ route('projects.tasks.store', $project) }}">
            ...
            <div class="px-7 py-6 border-b-[3px] border-ink flex items-center gap-4" style="background:#EFF6FF;">
              ...
              <div>
                <h2 class="font-display font-bold text-[20px] tracking-tight leading-tight">Nouvelle tâche</h2>
                <p class="text-[12px] text-ink/60 font-mono mt-0.5">Projet : {{ $project->title }}</p>
              </div>
            </div>
            ...
            <div class="px-7 py-6 space-y-6">
              <div>
                ...
                <input id="title" name="title" type="text" value="{{ old('title') }}" maxlength="255"
                       placeholder="e.g. Intégrer les notifications push" autofocus required
              ...
              <div>
                ...
                <textarea id="description" name="description" rows="4" required
                          placeholder="Ce qu'il faut faire, contexte, critères d'acceptation, liens…"
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input id="deadline" name="deadline" type="datetime-local" value="{{ old('deadline') }}"
              ...
              <div>
                ...
                @error('priority')
                  <p class="form-err"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>{{ $message }}</p>
                @enderror
                <p class="font-mono text-[10px] text-ink/50 mt-1.5">La tâche démarre au statut <strong>À faire</strong>.</p>
              </div>
            </div>
